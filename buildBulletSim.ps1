...
#$CFLAGS = "/I`"$BINCLUDEDIR`" /I. /Zi /EHsc /W3 /nologo /LD /MT /O2 /arch:AVX /fp:fast $VERSIONCFLAGS /D BULLETSIM_EXPORTS /U BT_USE_DOUBLE_PRECISION /D BT_NO_DOUBLE_PRECISION /D btScalar=float /D BT_LARGE_FLOAT=1e18f"

$CFLAGS = "/I`"$BINCLUDEDIR`" /I. /Zi /EHsc /W3 /nologo /LD /MT /O2 /arch:AVX /fp:fast $VERSIONCFLAGS /D BULLETSIM_EXPORTS /U BT_USE_DOUBLE_PRECISION /D BT_NO_DOUBLE_PRECISION /D BT_LARGE_FLOAT=1e18f"
